...
class Fish_Video_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        save_pickle(
            data_dict,
            os.path.join(save_path, str(self.epoch), self.split, '%s.pkl' % index),
        )
...
def get_dataloader(
    split, batch_size, seed, epoch, shuffle=False, drop_last=False, num_workers=8
):
...
if __name__ == '__main__':
    ...
    for i in range(1):
        train_loader = get_dataloader(
            split='train', batch_size=30, seed=25, num_workers=8, epoch=i
        )
        ...
        test_loader = get_dataloader(
            split='test', batch_size=30, seed=25, num_workers=8, epoch=i
        )
        ...
        val_loader = get_dataloader(
            split='val', batch_size=30, seed=25, num_workers=8, epoch=i
        )
